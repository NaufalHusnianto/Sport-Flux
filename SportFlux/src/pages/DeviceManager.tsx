...
const DeviceManager: React.FC = () => {
  ...
  return (
    <IonPage>
      ...
      <IonImg src="/Assets/img/IM2.png" style={{ position: 'fixed', top: '80%', left: '50%', transform: 'translate(-50%, -50%)', width: '80%', height: 'auto', opacity: 0.15 , zIndex: -1}} />
        {/* header  */}
            ...
            <IonGrid className='mb-2'>
              ...
              <IonRow>
                <IonCol size='4' className='p-3 d-flex align-items-center justify-content-center'>
                  <IonImg src='/Assets/img/T11.png' style={{ width: '100%', height: '90%', backgroundColor: '#122D3B', borderRadius: '20px', boxShadow: '0 4px 8px 0 rgba(0,0,0,0.8)' }}/>
                </IonCol>
      ...
      {/* content */}
        <IonCard color={'primary'} style={{ top: '25vh', borderRadius: '30px', background: 'rgba(0, 0, 0, 0.15)', boxShadow: '0 4px 8px 0 rgba(0,0,0,0.8)' }}>
